...
class App(object):
    def __init__(self):
        ...
        self.main_bet_amount = 0  # Total amount to wager. The program will split the two bets, so that the total wager is this amount
        self.lower_limit = 0.000  # Lower arbritage limit to bet on, as a percentage
        self.upper_limit = 0.0  # Upper arbritage limit to bet on, as a percentage (0.070 = 7%)
        self.bet_limit = 0.0  # Most websites require a minimum of $0.10 a wager on each bet
        self.odds_limit = 0  # The upper odds limit that you want to wager on (i.e. +750)
